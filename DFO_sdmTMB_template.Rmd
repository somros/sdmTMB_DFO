...
ggplot()+
  ...
  labs(title = paste(dfo_data$name,"CPUE from DFO bottom trawl survey"))#, dfo_data$stage, sep = " "))
```
...
write.csv(x = out, file = paste0("C:/Users/arove/Documents/GOA/SDM/Canada/outputs/knitted_output_afterSean/cpue_tables/",dfo_data$name[1],"_DFO.csv"), row.names = FALSE)
```
